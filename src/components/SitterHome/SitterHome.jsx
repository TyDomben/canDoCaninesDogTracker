...
import { Container, Grid, Card, CardMedia, CardContent, Typography, AppBar, Toolbar, IconButton } from '@mui/material';
import MenuIcon from '@mui/icons-material/Menu';
import HomeIcon from '@mui/icons-material/Home';

const SitterHomePage = ({ pastDogs, confirmedCommitments, pendingRequests, onDogSelect, onHomeClick }) => {
  return (
    <Container maxWidth="lg">
      ...
      <Grid container spacing={3} sx={{ mt: 3 }}>
        ...
        <Grid item xs={12} sm={4}>
          ...
          {pastDogs.map((dog) => (
            <Card key={dog.name} sx={{ my: 2 }} onClick={() => onDogSelect(dog)}>
              <CardMedia
                component="img"
                height="140"
        ...
        <Grid item xs={12} sm={4}>
          <Typography variant="h6">Sitter Requests Awaiting Confirmation</Typography>
